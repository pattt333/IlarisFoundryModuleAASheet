...
> Source: `docs/_specs/creature-sheet-spec.md`
...
The sheet SHALL have a tabbed layout with "Kampf" as the default tab and "Allgemein" as the secondary tab. All combat-relevant information SHALL be in the Kampf tab; descriptive and configuration data SHALL be in the Allgemein tab.

#### Scenario: Opening creature sheet

- **WHEN** a creature sheet is first rendered
- **THEN** the "Kampf" tab is selected by default

#### Scenario: Switching to Allgemein tab

- **WHEN** the user clicks the "Allgemein" tab
- **THEN** the Allgemein tab content is displayed, showing Kurzbeschreibung, Eigenschaften, Vorteile, Fertigkeiten, Kampfwerte, and item-creation controls
