...
Sidebar favorites component with category tabs, collapse/expand toggle, clear-all with confirmation dialog, and sessionStorage-based state persistence across sheet reopens.
