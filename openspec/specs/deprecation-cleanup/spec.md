...
Systematic elimination of deprecated Foundry API usage across the initiative subsystem. Ensures compatibility with Foundry V15+ by replacing V1 Application classes with ApplicationV2, V1 Dialog with DialogV2, jQuery DOM manipulation with vanilla DOM, and numeric ActiveEffect modes with string types.
