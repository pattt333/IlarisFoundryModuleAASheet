...
Three container types for actor inventory display — Mitführend (carrying), Unterstützend (supporting), and Handkarren (handcart) — each using the item-accordion component for item rendering.
