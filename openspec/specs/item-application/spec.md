...
"Gegenstand anwenden" dialog with Ilaris system target selection, socket-based multi-user item application, quantity consumption, and double-submission prevention using AppV2.
