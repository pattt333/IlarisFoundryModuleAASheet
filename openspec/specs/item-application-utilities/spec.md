...
Shared utility functions for the item application pipeline: quantity consumption, socket payload construction, target application (healing/damage/effects), and bleeding effect application from the effect library compendium.
